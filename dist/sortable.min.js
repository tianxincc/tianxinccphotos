...
var Sortable = function () {
  function d() {
    var t = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, e = t.parent, n = t.links,
      i = void 0 === n ? document.querySelectorAll('[data-sjslink]') : n, s = t.active,
      a = void 0 === s ? 'is-active' : s, r = t.margin, o = void 0 === r ? 20 : r, l = t.responsive,
      u = void 0 === l ? {720: {columns: 3}, 480: {columns: 2}, 0: {columns: 1}} : l, c = t.fadeDuration,
  ...
  return _createClass(d, [{
    key: 'orderelements', value: function () {
      var r = this, t = this.parent, e = this.activeElements, o = this.columns, l = this.blocWidth,
        u = (this.responsive, this.margin), n = e.reduce(function (t, e, n) {
          var i = r._sumArrHeight(t, o), s = n % o * (l + u), a = 0 <= n - o ? i[n % o] + u * Math.floor(n / o) : 0;
    ...
    key: 'handleFilterClick', value: function (t, e) {
      var n = this;
      t.preventDefault();
      var i = this.links, s = this.active;
    ...
    key: 'init', value: function () {
      var n = this, t = this.parent, e = this.links, i = this.active;
    ...
    key: '_setBlocWidth', value: function (t) {
      var e = this.parent, n = this.elements, i = this.margin, s = this.responsive,
        a = this.columns = this._columnsCount(s).columns, r = this.blocWidth = (e.clientWidth - i * (a - 1)) / a;
    ...
    key: '_filterElements', value: function (t) {
      var e = this, n = this.elements, i = this.dataLink, s = this.fadeDuration;
    ...
    key: '_fadeIn', value: function (e) {
      var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 300, n = arguments[2],
        i = parseFloat(window.getComputedStyle(e, null).getPropertyValue('opacity')), s = 16 / t;
    ...
    key: '_fadeOut', value: function (e) {
      var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 300, n = arguments[2],
        i = parseFloat(window.getComputedStyle(e, null).getPropertyValue('opacity')), s = t ? 16 / t : 1;
